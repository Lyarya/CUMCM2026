...
18 & {\raggedright results/\allowbreak{}problem4/\allowbreak{}Q4\_\allowbreak{}GIVEN\_\allowbreak{}PRICE\_\allowbreak{}INDEPENDENT\_\allowbreak{}AUDIT.json\par} & JSON & 问题四 & 动态价格年度独立审计 & Q4年度结果 & 价格、物理与结算核验 \\
19 & {\raggedright requirements-lock.txt\par} & 文本 & 全部 & Python依赖精确版本 & 环境冻结 & 可复现安装清单 \\
20 & {\raggedright paper/\allowbreak{}AI工具使用详情.pdf\par} & PDF & 支撑材料 & AI工具使用情况与人工核验记录 & 实际AI辅助记录 & 独立AI工具使用详情 \\
\bottomrule
\end{longtable}
\endgroup
